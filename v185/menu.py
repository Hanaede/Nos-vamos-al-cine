...
class Menu:
    ...
    def show_menu(self):
        while True:
            ...
            print("4. Películas trending semanales por género o todos los disponibles")
            print("5. Películas trending del dia por género o todos los disponibles")
            ...
            if choice == '1':
                ...
                self.tmdb_client.get_trending_week_movies_by_genre()
            elif choice == '5':
                self.tmdb_client.get_trending_day_movies_by_genre()
            elif choice == '6':
